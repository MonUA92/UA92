...
<body style="background-color:#D7D4DD ;">
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #324ab2;">
		...
		<h3 class="title">Add a new Parent</h3>
	
		<form class="main-form" method="post" action="addParent.php">

        <label id="stitle">Select Student:</label>
			<select class="input" name="StudentID">
				<?php
              ini_set('display_errors', 1);
error_reporting(E_ALL);
				$sql = mysqli_query($conn, "SELECT StudentID, StudentName FROM Student");
            ...
            <label id="stitle">Parent Name:</label>
            <input class="input" type="text" name="ParentName" required>
			
			<br>

            <label id="stitle">Parent Address:</label>
            <input class="input" type="text" name="ParentAddress" required>
           ...
           <label id="stitle">PhoneNum:</label>
          
          <input class="input" type="text" name="PhoneNum" required>
...
error_reporting(E_ALL);
		if (isset($_POST['submit'])) {
            ...
            (ParentName,ParentAddress,Email,PhoneNum,StudentID) VALUES 
            ('$ParentName', '$ParentAddress', '$Email', '$PhoneNum', '$StudentID')";
