...
<head>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #324ab2;">
        ...
        <h3 class="main-title">Delete a Teacher</h3><br>
	...
	<td><?php echo $row["TeacherPNumber"]; ?></td>
    <td><?php echo $row["TeacherMedical"]; ?></td>
    <td><?php echo $row["Background"]; ?></td>
    <td><?php echo $row["Salary"]; ?></td>
	<td><a href="RemoveTeacher.php?TeacherID=<?php echo $row["TeacherID"]; ?>"><button>Delete</button</a></td>
	</tr>
	<?php
	$i++;
	}
