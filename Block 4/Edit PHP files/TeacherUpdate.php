...
$table = mysqli_query($conn,"SELECT * FROM teacher");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
?>
		...
		<h3 class="main-title">Update a Teacher</h3><br>
	...
	<th><?php echo $row["TeacherName"]; ?></th>
	<th><?php echo $row["TeacherAddress"]; ?></th>
	<th><?php echo $row["TeacherPNumber"]; ?></th>
    <th><?php echo $row["TeacherMedical"]; ?></th>
    <th><?php echo $row["Background"]; ?></th>
    <th><?php echo $row["Salary"]; ?></th>
	<th><a href="EditTeacher.php?TeacherID=<?php echo $row["TeacherID"]; ?>"><button>Edit</button</a></td>
	</tr>
	<?php
	$i++;
	}
