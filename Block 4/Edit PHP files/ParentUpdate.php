...
$table = mysqli_query($conn,"SELECT * FROM parents");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
?>
		...
		<h3 class="main-title">Update a Parent</h3><br>
	
		<table style="width: 40%; margin: auto; width: auto;" class="main-table" >
		<thead>
			<tr>
				<th width="150px">ParentID<br><hr></th>
				<th width="250px">ParentName<br><hr></th>
				<th width="150px">ParentAddress<br><hr></th>
                <th width="150px">Email<br><hr></th>
                <th width="150px">PhoneNum<br><hr></th>
	...
	<th><?php echo $row["ParentName"]; ?></th>
	<th><?php echo $row["ParentAddress"]; ?></th>
	<th><?php echo $row["Email"]; ?></th>
    <th><?php echo $row["PhoneNum"]; ?></th>
    <th><?php echo $row["StudentID"]; ?><thtd>
	<th><a href="EditParent.php?ParentID=<?php echo $row["ParentID"]; ?>"><button>Edit</button</a></td>
	</tr>
	<?php
	$i++;
	}
