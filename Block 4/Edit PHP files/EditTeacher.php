...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE teacher set TeacherID='" . $_POST['TeacherID'] . "', TeacherName='" . $_POST['TeacherName'] . "', TeacherAddress='" . $_POST['TeacherAddress'] . "', TeacherPNumber='" . $_POST['TeacherPNumber'] . "', TeacherMedical='" . $_POST['TeacherMedical'] . "', Background='" . $_POST['Background'] . "', Salary='" . $_POST['Salary'] . "' WHERE TeacherID='" . $_POST['TeacherID'] . "'");
$note = '<script>alert("This has now been modified, please return to Parent page!")</script>';
}
$table = mysqli_query($conn,"SELECT * FROM teacher WHERE TeacherID='" . $_GET['TeacherID'] . "'");
...
<body style="background-color:#D7D4DD ;">
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #324ab2;">
		...
		<hr>
<h3 class="title">Edit a Teacher</h3>
...
<label id="title">TeacherName</label>
<input type="text" name="TeacherName" class="input" value="<?php echo $row['TeacherName']; ?>"required>
			
<br>

<label id="title">Teacher Address</label>
<input type="text" name="TeacherAddress" class="input" value="<?php echo $row['TeacherAddress']; ?>"required>
			
<br>

<label id="title">TeacherPNumber</label>
<input type="number" name="TeacherPNumber" class="input" value="<?php echo $row['TeacherPNumber']; ?>"required>

<br>

<label id="title">Teacher Medical</label>
<input type="text" name="TeacherMedical" class="input" value="<?php echo $row['TeacherMedical']; ?>"required>

<br>

<label id="title">Background</label>
<input type="text" name="Background" class="input"  value="<?php echo $row['Background']; ?>"required>

<br>
<label id="title">Salary</label>
<input type="number" name="Salary" class="input" value="<?php echo $row['Salary']; ?>"required>
